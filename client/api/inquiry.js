  ...
  <html>
    <head>
      ...
      <style>
        ...
        .message-title { color: #091e3e; font-size: 14px; font-weight: bold; margin-top: 20px; margin-bottom: 8px; }
        .message-box { background-color: #f8fafc; border-left: 4px solid #06a3da; padding: 15px; border-radius: 4px; font-size: 14px; line-height: 1.5; color: #334155; white-space: pre-wrap; }
        ...
        .badge { display: inline-block; padding: 4px 8px; background-color: #e0f2fe; color: #0369a1; border-radius: 4px; font-weight: bold; font-size: 12px; }
      </style>
    </head>
    <body>
      <div class="wrapper">
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ success: true, message: 'Inquiry email sent' });
  } catch (error) {
